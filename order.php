...
if (!isset($_SESSION['user_id'])) {
    ...
    $_SESSION['no-login-message'] = "<div class='error text-center'>Please log in to place an order.</div>";
...
$user_query = "SELECT full_name, contact, email FROM tbl_user WHERE id_no = '$user_id'"; // Query to get user details
    ...
    <div class="container">
        ...
        <form action="" method="POST" class="order">
            ...
            <fieldset style="color: white;">
                ...
                <input type="text" name="full-name" placeholder="Tracy Wangari" class="input-responsive" required value="<?php echo htmlspecialchars($user_data['full_name']); ?>">

                <div class="order-label">Phone Number</div>
                <input type="tel" name="contact" placeholder="0700000000" class="input-responsive" required value="<?php echo htmlspecialchars($user_data['contact']); ?>">

                <div class="order-label">Email</div>
                <input type="email" name="email" placeholder="tracy@gmail.com" class="input-responsive" required value="<?php echo htmlspecialchars($user_data['email']); ?>">
